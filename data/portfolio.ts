...
export const projects: Project[] = [
  ...
  },
  {
    ...
    problem:
      "미국 거시경제 환경을 분석하고 금융시장에 미치는 영향을 전망하기 위해 SAFE 금융경제분석학회에서 경제 리서치 프로젝트를 수행했습니다.\n\n고용, 인플레이션, 제조업, 채권 등 주요 거시지표를 분석하여 미국 경제의 흐름을 해석하고, 투자 관점에서 시장 영향을 제시하는 경제보고서를 작성했습니다. 저는 고용팀에서 미국 노동시장 데이터를 분석하고 경기 국면과 투자 시사점을 도출하는 역할을 담당했습니다.",
    actions: [
      "FRED, BLS 등 공개 경제 데이터를 활용하여 Nonfarm Payrolls, 실업률, 노동참가율, JOLTS, Jobless Claims 등 미국 고용지표를 분석했습니다.",
      "단순 수치 비교가 아닌 노동시장 구조 변화와 임금, 소비, 인플레이션의 관계를 함께 해석하여 경기 사이클을 분석했습니다.",
      "차트 기반 리서치를 수행하고 데이터 시각화와 경제 해석을 통해 고용시장 리포트를 작성했습니다.",
      "노동시장 둔화와 지속적인 인플레이션이 동시에 나타나는 초기 스태그플레이션 가능성을 제시하고, 연준 통화정책 및 금융시장에 미칠 영향을 분석했습니다.",
      "팀원들과 함께 인플레이션·제조업·채권 분석 결과를 종합하여 하나의 거시경제 보고서를 제작하고 투자 전략 및 시장 전망을 제안했습니다.",
    ],
    result: "거시경제 지표를 연결해 시장 시나리오와 투자 시사점을 도출하는 분석 역량을 키웠습니다.",
    learnings: [
      "경제지표는 개별적으로 보기보다 서로 연결해서 해석해야 한다는 점을 배웠습니다. 고용, 임금, 소비, 인플레이션, 금리의 관계를 함께 분석하며 거시경제를 바라보는 관점을 익혔습니다.",
      "경제 데이터 분석에서는 숫자보다 변화의 원인을 설명하는 것이 중요하다는 점을 경험했습니다. 단순히 실업률이 하락했다는 사실보다 노동참가율 감소와 노동시장 경직성까지 함께 고려해 해석했습니다.",
      "투자 관점의 리서치는 데이터 분석과 스토리텔링이 함께 이루어져야 한다는 점을 배웠습니다. 여러 경제지표를 연결해 시장 시나리오를 구성하고 투자 시사점을 도출하는 경험을 했습니다.",
      "거시경제 분석은 시장 예측보다 다양한 가능성을 고려한 시나리오 기반 사고가 중요하다는 점을 체감했습니다. 동일한 경제지표라도 연준 정책과 시장 기대에 따라 다른 결과가 나타날 수 있음을 학습했습니다.",
      "팀 프로젝트를 통해 하나의 보고서를 공동으로 작성하며 데이터 분석 결과를 일관된 투자 관점으로 정리하는 협업 경험을 쌓았습니다.",
    ],
    tags: [
      "Python",
      "FRED API",
